...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/image-previewer.css">
</head>
        ...
        <div id="left-nav">
            ...
            <div class="clip1">
                <a href="updatephoto.php" title="Change Profile Picture"><img
                        src="<?php echo $row['profile_picture'] ?>"></a>
            </div>
...
?>
	...
	$sql = "SELECT * from post where user_id='$user_session_id'";
...
<script src="js/img-previewer.min.js"></script>
<script>
