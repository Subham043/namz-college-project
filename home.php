...
?>
		<div id="right-nav1">
			...
			<a href="profile.php?user=<?php echo $user_id; ?>"><img src="<?php echo $profile_picture ?>"></a>
			<a href="profile.php?user=<?php echo $user_id; ?>"><b><?php echo $posted_by ?></b></a>
			<?php }else{ ?>
			<a href="profile.php"><img src="<?php echo $profile_picture ?>"></a>
			<a href="profile.php"><b><?php echo $posted_by ?></b></a>
			<?php } ?>
...
?>			
			<div class="comment-display"<?php echo $comment_id ?>>
				...
				<?php if($row['user_id']!=$_SESSION['id']){ ?>
					<a href="profile.php?user=<?php echo $user_id; ?>"><img src="<?php echo $row['image']; ?>"></a>&nbsp;&nbsp;&nbsp;<a href="profile.php?user=<?php echo $user_id; ?>"><?php echo $row['name']; ?></a>
					<?php }else{ ?>
